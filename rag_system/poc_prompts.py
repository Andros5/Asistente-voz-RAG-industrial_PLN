...
Tu unica tarea es reescribir la consulta de forma clara, completa y precisa, sin responderla.
Manten codigos de error, nombres de piezas, siglas y referencias tecnicas tal como aparecen.
Si hay ambiguedad, conserva la formulacion mas prudente y no inventes informacion.
No hagas preguntas de aclaracion. No propongas comprobaciones, diagnosticos ni pasos.
No rechaces la tarea: se trata de normalizacion documental para una PoC academica.
...
Salida: Que procedimiento debe seguirse para resolver la alarma 12345 asociada al eje?"""
...
PROMPT_T4B = """Traduce y adapta al espanol la respuesta tecnica proporcionada en ingles.
Debe sonar natural para un operario, ser breve y mantener un tono imperativo o instructivo.
No anadas pasos nuevos. Conserva obligatoriamente las etiquetas de referencias documentales (ej. [REF:1]).
...
Si la respuesta en ingles dice que la evidencia es insuficiente, traduce solo esa falta de evidencia; no inventes un procedimiento alternativo.
Devuelve solo la respuesta final en espanol, sin introducciones."""
